<template>
  <Teleport to="#endofbody" v-if="mounted">
    <VueFinalModal
      v-model="show"
      :name="name"
      :classes="classes"
    ...
    >
      <div
        ...
        :style="[
          `max-width: ${maxWidth}px; min-width: ${minWidth}px; width: ${width}px; max-height: ${height}px;`,
        ]"
      >
        <button
